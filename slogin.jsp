...
<body>
    <img src="sd.png" height="60px" width="150px">
  ...
  <div class="login-html">
    ...
    <div class="login-form">
      ...
      <form class="sign-up-htm" action="contactform" method="POST">
       <div class="group">
        ...
        <div class="group">
          <label for="" class="label">enrollemtno</label>
          <input id="pass" type="text" name="enrollementno" class="input" data-type="password">
        </div>
        <div class="group">
